...
const RequestBlood = () => {
  ...
  return (
    <SafeAreaView style={{marginTop:Platform.OS === "android" ? 50 :0,}}>
      <Text style={{fontSize:20, textAlign:'center',fontWeight:'bold', color:"#5180da"}}>Blood Request Page</Text>
     ...
     <View style={{alignItems:'center', justifyContent:'center', margin:30,}}>
      ...
      <TextInput value={address} onChangeText={(text)=>setAddress(text)}      placeholder="Address" style={{ width:350, borderRadius:7, height:200, borderColor:"#a6a1b7", borderWidth:1, padding:5, margin:8}} />
     </View>
    
    <View style={{alignItems:'center', justifyContent:'center'}}>
        <Pressable onPress={bloodrequestdata} style={{backgroundColor:'#5180da', width:350,height:50,borderRadius:7,alignItems:'center', justifyContent:'center'}}>
...
const styles = StyleSheet.create({
  TextInput1:{
    width:350, borderRadius:7, height:50, borderColor:"#a6a1b7", borderWidth:1, padding:5, margin:8
  }
})